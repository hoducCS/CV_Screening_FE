  ...
  return (
    <div className="w-full">
      ...
      <input
        {...props}
        id={id}
        className={`border-primary bg-gray-50 border-solid border-2  text-gray-900 text-sm rounded-lg  block w-full p-2.5 placeholder-placeholder h-[55px] focus:outline-none` }
